...
namespace System.Linq.Expressions
{
    internal static class CachedReflectionInfo
    {
        ...
        private static MethodInfo s_RuntimeOps_CreateRuntimeVariables_IRuntimeVariables_Int64Array;
        public  static MethodInfo   RuntimeOps_CreateRuntimeVariables_IRuntimeVariables_Int64Array =>
                                  s_RuntimeOps_CreateRuntimeVariables_IRuntimeVariables_Int64Array ??
                                 (s_RuntimeOps_CreateRuntimeVariables_IRuntimeVariables_Int64Array = typeof(RuntimeOps).GetMethod(nameof(RuntimeOps.CreateRuntimeVariables), new[] { typeof(IRuntimeVariables), typeof(long[]) }));
        ...
        public  static MethodInfo   RuntimeOps_Quote =>
                                  s_RuntimeOps_Quote ??
                                 (s_RuntimeOps_Quote = typeof(RuntimeOps).GetMethod(nameof(RuntimeOps.Quote), new[] { typeof(Expression), typeof(object), typeof(IRuntimeVariables) }));
