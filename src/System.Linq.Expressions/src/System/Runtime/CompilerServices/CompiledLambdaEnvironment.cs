...
namespace System.Runtime.CompilerServices
{
    ...
    public sealed class CompiledLambdaEnvironment<TLocals, TConstants>
    {
        /// <summary>
        ...
        public readonly TConstants Constants;

        /// <summary>
        /// Represents the hoisted local variables from the parent context. 
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        public readonly TLocals Locals;
        ...
        public CompiledLambdaEnvironment(TConstants constants, TLocals locals)
        {
            Constants = constants;
            Locals = locals;
        }
